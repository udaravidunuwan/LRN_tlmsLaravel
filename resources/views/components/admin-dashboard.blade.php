...
{{-- <div class="bg-gray-200 dark:bg-gray-800 bg-opacity-25 grid grid-cols-4 md:grid-cols-2 gap-6 lg:gap-8 p-6 lg:p-8"> --}}
    <div>
        <div class="flex items-center">
            <h2 class="ml-3 text-xl font-semibold text-gray-900 dark:text-white">Completed</h2>
        </div>
        <div class="flex items-center">
            <p class="mt-4 text-gray-500 dark:text-gray-400 text-sm leading-relaxed">100</p>
        </div>
